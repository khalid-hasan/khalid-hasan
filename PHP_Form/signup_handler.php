...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    {
        $confirmEmail= data_sanitization($_POST["confirm_email"]);
    }
    if(isset($_POST["pwd"]))
    {
...
<div class="container">
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="form-group">
                <label>Email address:</label> <?php echo "$emailAddress"; ?>
            </div>
            
            <div class="form-group">
                <label>Confirmed Email address:</label> <?php echo "$confirmEmail"; ?>
            </div>
